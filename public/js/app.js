...
/* WEBPACK VAR INJECTION */(function($) {axios = __webpack_require__(12);
...
(function () {
  ...
  var app = {
    ...
    restock: function restock(e) {
      e.preventDefault();
      this.url = $('#restockForm').attr('action');
      this.ajaxRequest();
    },
    sell: function sell(e) {
      e.preventDefault();
      this.url = $('#sellForm').attr('action');
      this.ajaxRequest();
    },
    ajaxRequest: function ajaxRequest() {
      axios.post('/api' + this.url).then(function (response) {
        app.displayStock(response);
      }).catch(function (response) {});
    },
    displayStock: function displayStock(response) {
